...
class Match extends React.Component {
    ...
    <h2>{date}</h2>
        ...
        <div className="score">
            ...
            <div className="vs"><h3>{this.props.stadium.city}</h3></div>
            <div>{homeResult || "Not yet played"}</div> 
        </div>
   

        <div className="score">
            <div><strong>{this.props.away_team.name}</strong></div>
            <div className="vs"> VS </div>
            <div><strong>{this.props.home_team.name}</strong></div> 
        </div>


        <div className="score">
            <div><img src={this.props.away_team.flag} /></div>
            <div className="vs"></div>
            <div><img src={this.props.home_team.flag} /></div> 
        </div>
